...
function showWelcome() {
  ...
  let dist = getDistance(113.943748, 22.524643, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function getWeibo() {
  fetch('https://wb.vsec.asia/api').then(data => data.json()).then(data => {  // 这里要写上你的API!!!
  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/snow-ls.png",
        hoverMsg: "嘻嘻~",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://cdn.jsdelivr.net/gh/linjiangyu2/halo/svg/Tianlin-my.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站已经运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://cdn.jsdelivr.net/gh/linjiangyu2/halo/svg/Tianlin-xb.svg' title='休息的时间就应该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站已经运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/003655-16858102157402.jpg);
    --darkmode-bg:url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/music.webp);
    --mobileday-bg: url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/snow.webp);
    --mobilenight-bg: url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/mb4.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://cdn.jsdelivr.net/gh/linjiangyu2/halo/img/home_bg.webp"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
